...
final habitsProvider = FutureProvider.autoDispose<List<Habit>>((ref) async {
  ...
  AppLogger.info(
      '🔍 habitsProvider (deprecated): Fetched ${habits.length} habits from database');
