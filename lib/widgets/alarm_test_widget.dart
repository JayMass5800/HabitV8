...
class _AlarmTestWidgetState extends State<AlarmTestWidget> {
  ...
  Future<void> _cancelTestAlarm() async {
    try {
      await AlarmService.cancelHabitAlarms('test_habit');
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Instructions:\n'
              '1. Schedule a test alarm to verify alarm functionality\n'
              '2. Wait 10 seconds for alarm to fire\n'
              '3. Test complete/snooze actions\n'
