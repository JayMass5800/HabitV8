...
open class HabitCompactWidgetProvider : HomeWidgetProvider() {
    ...
    override fun onUpdate(
        ...
        // Only trigger refresh if there's no habit data at all AND we haven't recently tried to refresh
        ...
        if (!hasHabitsData) {
            ...
            if (timeSinceLastRefresh > minRefreshInterval) {
                Log.w("HabitCompactWidget", "No habit data found, triggering refresh (last attempt was ${timeSinceLastRefresh}ms ago)")
                ...
                Log.d("HabitCompactWidget", "Skipping refresh - too soon since last attempt (${timeSinceLastRefresh}ms ago, need ${minRefreshInterval}ms)")
            }
        }
